    ...
    <div>
      ...
      <div className="mt-4" required>
        ...
        <div className="relative">
          ...
          <button
            type="button"
            className="absolute inset-y-0 right-0 flex items-center px-4 text-gray-600 hover:pointer"
      ...
      <div className="flex justify-center mt-4">
        <button
          type="button"
          className="w-3/6 flex justify-center text-white bg-gray-600 hover:bg-gray-800 focus:ring-2 focus:ring-gray-400 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
